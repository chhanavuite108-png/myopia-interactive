...
@media(max-width:850px) { .shell { display:flex !important; flex-direction:column !important; flex-wrap:nowrap !important; min-height:0 !important; }.sidebar { min-width:0 !important; width:100% !important; max-width:100% !important; flex:0 0 auto !important; padding:10px 18px 5px !important; }.sidebar h2, .sidebar .side-note, .sidebar .gr-button { display:none !important; }.sidebar .block { margin-bottom:3px !important; }.sidebar label { font-size:14px !important; }.content { width:100% !important; max-width:100% !important; min-width:0 !important; padding:12px 14px 20px !important; }.title h1 { font-size:25px !important; letter-spacing:-.7px !important; margin-bottom:4px !important; }.subtitle, .mobile-hide { display:none !important; }.notice { padding:9px 11px !important; margin:5px 0 7px !important; font-size:13px !important; }.vision-panel { margin:4px 0 7px !important; padding:9px 11px !important; align-items:center !important; }.vision-label { font-size:13px !important; }.vision-state { font-size:19px !important; }.vision-panel p { font-size:12px !important; line-height:1.3 !important; }.vision-target { width:58px; height:58px; font-size:44px; flex:0 0 auto; }.diagram { width:100%; height:auto; max-height:none; aspect-ratio:1320 / 630; border-radius:8px; background:#0d1016; }.diagram .label { font-size:28px; }.diagram .small-label { font-size:26px; }.diagram .axis-text { font-size:22px; } }
"""
...
with gr.Blocks(css=CSS, title="Myopia Interactive", theme=gr.themes.Base()) as demo:
    with gr.Row(elem_classes="shell"):
        ...
        with gr.Column(scale=5, elem_classes="content"):
            ...
            with gr.Row(elem_classes="metric-row mobile-hide"):
